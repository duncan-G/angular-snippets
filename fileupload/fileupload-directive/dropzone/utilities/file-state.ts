...
export class FileState {
    ...
    //
    public isFileValid(fileList=null): RejectionReasons {

        // Get the file
        // fileList arg is passed when file is uploaded from input
        let currentFiles: FileList = fileList || this.getFiles();
    ...
    //
    public verifyFiles(fileList=null): DroppedFiles {
